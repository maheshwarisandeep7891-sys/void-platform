          ...
          <div className="p-6">
            ...
            <div className="flex items-start justify-between mb-4">
              ...
              <div className="flex items-center gap-1">
                ...
                {/* Share to Twitter */}
                <a
                  href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(`${post.title ?? post.content.slice(0, 80)} — by @${post.author?.username} on VOID`)}&url=${encodeURIComponent(`https://void-platform.vercel.app/post/${post.id}`)}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 rounded-lg text-void-muted hover:text-[#1DA1F2] hover:bg-[#1DA1F2]/10 transition-all"
