...
export default function SignInPage() {
  ...
  // Use direct URL redirect for GitHub OAuth instead of signIn()
  // This avoids CSRF issues with custom signin pages
  const handleGitHub = () => {
    setLoading("github");
    // Redirect directly to NextAuth's GitHub signin endpoint
    window.location.href = "/api/auth/signin/github?callbackUrl=/feed";
  };

  const handleGoogle = () => {
    setLoading("google");
    window.location.href = "/api/auth/signin/google?callbackUrl=/feed";
  };
          ...
          {emailSent ? (
            ...
            <>
              ...
              <div className="space-y-3 mb-6">
                {/* GitHub — direct URL redirect, no CSRF needed */}
                <a
                  href="/api/auth/signin/github?callbackUrl=%2Ffeed"
                  className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg font-mono text-sm font-medium bg-[#24292e] hover:bg-[#2f363d] text-white border border-[#444d56] transition-colors"
                >
                ...
                <a
                  href="/api/auth/signin/google?callbackUrl=%2Ffeed"
                  className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg font-mono text-sm font-medium border border-void-border bg-transparent text-void-text hover:bg-void-surface transition-colors"
                >
